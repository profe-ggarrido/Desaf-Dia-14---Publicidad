...
while True:
    try:
        ...
        if nuevo_tipo == "Video":
            print(f"Esta campaña: \033[41m'{nuevo_nombre}'\033[0m ,\n será anunciada mediante un formato \033[42m'{nuevo_tipo}'\033[0m y por una plataforma \033[43m'{nuevo_sub_tipo}'\033[0m con una duración de: {nueva_duracion} hrs.")
        else:
            print(f"Esta campaña: \033[41m'{nuevo_nombre}'\033[0m ,\n será anunciada mediante un formato \033[42m'{nuevo_tipo}'\033[0m y por una plataforma \033[43m'{nuevo_sub_tipo}'\033[0m") 
