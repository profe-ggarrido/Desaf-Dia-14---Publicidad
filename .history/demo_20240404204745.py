...
while True:
    try:
        ...
        #print(mi_campaña)
        print(f"Esta campaña: \033[41m'{nuevo_nombre}'\033[0m , será anunciada mediante un formato \033[42m'{nuevo_tipo}'\033[0m y por una plataforma \033[43m'{nuevo_sub_tipo}'\033[0m")
