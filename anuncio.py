...
# Modif para detalle de la campaña y sus datos
    def __repr__(self):
        return f"Tipo: {self.__class__.__name__}, Sub-tipo: {self.__sub_tipo}"
...
#Modif para mostra solo datos de la campaña
    def __repr__(self):
        return f"Tipo: {self.__class__.__name__}, Sub-tipo: {self.__sub_tipo}, Duración: {self.__duracion}"
